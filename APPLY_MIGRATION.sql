-- ============================================
-- ПРИМЕНИТЕ ЭТОТ SQL В SUPABASE DASHBOARD
-- ============================================
-- Откройте: https://supabase.com/dashboard/project/mtpawypaihmwrngirnxa
-- Перейдите в: SQL Editor
-- Скопируйте весь SQL ниже и выполните
-- ============================================
...
-- 1. Попробуйте создать карточку подопечного из аккаунта организации
-- 2. Должно работать без ошибок 403 Forbidden
-- ============================================
