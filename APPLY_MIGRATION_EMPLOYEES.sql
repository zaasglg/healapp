-- ============================================
-- МИГРАЦИЯ ДЛЯ ИСПРАВЛЕНИЯ ОТОБРАЖЕНИЯ СОТРУДНИКОВ
-- ============================================
...
-- Исправление функции has_organization_access для случая, когда current_user_role() возвращает null
...
COMMENT ON FUNCTION public.has_organization_access(uuid) IS 
  'Проверяет доступ к организации. Для организаций учитывает случай, когда current_user_role() возвращает null.';

-- ============================================
-- МИГРАЦИЯ ПРИМЕНЕНА!
-- ============================================
-- Теперь:
-- 1. Организации смогут видеть свои приглашения даже если current_user_role() возвращает null
-- 2. Организации смогут видеть своих сотрудников даже если current_user_role() возвращает null
-- 3. Страница EmployeesPage автоматически обновляется каждые 3 секунды
-- 4. Добавлена кнопка ручного обновления списка сотрудников
-- ============================================
